...
https://github.com/gabriel-tfg/Tabajo_Data_Streams

En dicho repositorio se incluye:
- El fichero RMarkdown completo.
- El script de implementación.
- El fichero Excel con las predicciones y métricas.
- Las instrucciones necesarias para reproducir el experimento.
